...
/// Default [TinyColumnChartOptions] for [TinyColumnChart.new] and
/// [TinyColumnChart.fromDataVectors].
const kDefaultColumnChartOptions = TinyColumnChartOptions(
  positiveColor: AppColors.green,
...
///
/// See also:
/// - [TinyColumnChart.new] to build a column chart based on a list of numbers.
